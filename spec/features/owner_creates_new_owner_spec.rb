...
describe 'a real estate agent wants to add a new owner' do
  ...
  #Must have the option to add a company name
    ...
    it "It has all the correct fields available to create an owner" do
...
context "check to see if an owner can be created succesfully" do
  ...
  context "Owner is not created if all fields aren't filled" do

    it "doesn't create an owner when you do not fill in email_address" do
